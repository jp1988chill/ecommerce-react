...
function M2(t2) {
  var e = "undefined" != typeof self && (self.crypto || self.msCrypto), n = new Uint8Array(t2);
...
var X2 = function() {
  function t2(t3) {
    this.fields = t3, t3.sort($.comparator);
  }
...
var Wt = function(t2, e, n, r, i, o, s, u) {
  void 0 === e && (e = null), void 0 === n && (n = []), void 0 === r && (r = []), void 0 === i && (i = null), void 0 === o && (o = "F"), void 0 === s && (s = null), void 0 === u && (u = null), this.path = t2, this.collectionGroup = e, this.explicitOrderBy = n, this.filters = r, this.limit = i, this.limitType = o, this.startAt = s, this.endAt = u, this.p = null, this.T = null, this.startAt, this.endAt;
};
...
function xe(t2, e, n) {
  t2 instanceof Pe ? function(t3, e2, n2) {
    ...
    Ae(t3.precondition, e2) && e2.convertToNoDocument(K2.min());
  }(t2, e);
}
function Re(t2, e) {
...
var yn = function() {
  function t2(t3) {
    this.W = t3, this.G = /* @__PURE__ */ new Map(), this.H = Ze(), this.J = vn(), this.Y = new $e(q2);
  }
    ...
    this.forEachTarget(t3, function(n) {
      ...
      switch (t3.state) {
        case 0:
          ...
          break;
        case 1:
          r.K(), r.F || r.L(), r.O(t3.resumeToken);
          break;
        case 2:
...
var Tr = function() {
  function t2(t3, e) {
    var n = this;
    this.action = t3, this.transaction = e, this.aborted = false, this.ft = new br(), this.transaction.oncomplete = function() {
      n.ft.resolve();
...
var _r = function() {
  function t2(e, n, r) {
    this.name = e, this.version = n, this.wt = r, 12.2 === t2._t(getUA()) && x2("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
  }
...
function zr(t2) {
  ...
  return "LAST" === t2.limitType ? re(e, e.limit, "L") : e;
}
var Wr = function() {
  function t2() {
  }
...
var wi = function() {
  ...
  return t2.prototype.he = function(t3) {
    ...
    return r.$t({
      ...
      0 === o ? (i !== S2.o && e(new ct(tr(n)), i), i = u, n = s) : i = S2.o;
    }).next(function() {
...
var Ei = function(e) {
  function n(t2, n2) {
    var r = this;
    return (r = e.call(this) || this).Ie = t2, r.trackRemovals = n2, r.Ae = new Ii(function(t3) {
      return t3.toString();
    }, function(t3, e2) {
...
var Ai = function() {
  ...
  return t2.prototype.Rt = function(t3, e, n, r) {
    ...
    var s = Ir.resolve();
    return n < 3 && r >= 3 && (0 !== n && (function(t4) {
      ...
      return i = e2, o.Rn(t3, i, r).next(function(t4) {
        ...
        for (var e3 = 0, n2 = i; e3 < n2.length; e3++)
          for (var o2 = n2[e3], s = 0, u = o2.mutations; s < u.length; s++) {
            ...
            null == h && (h = Nt.newInvalidDocument(c), r = r.insert(c, h)), xe(a, h, o2.localWriteTime), h.isFoundDocument() || (r = r.remove(c));
          }
      });
    }).next(function() {
...
var qi = function() {
  function t2(t3, e, n, r) {
    this.persistence = t3, this.xn = e, this.R = r, this.kn = new We(q2), this.Fn = new Ii(function(t4) {
      return kt(t4);
    }, Ct), this.$n = K2.min(), this._n = t3.getMutationQueue(n), this.On = t3.getRemoteDocumentCache(), this.qe = t3.getTargetCache(), this.Mn = new Fi(this.On, this._n, this.persistence.getIndexManager()), this.Ke = t3.getBundleCache(), this.xn.Vn(this.Mn);
  }
        ...
        case 0:
          return n = F2(t2), i = n._n, o = n.Mn, [4, n.persistence.runTransaction("Handle user change", "readonly", function(t3) {
            ...
            return n._n.getAllMutationBatches(t3).next(function(s2) {
              return r2 = s2, i = n.persistence.getMutationQueue(e), o = new Fi(n.On, i, n.persistence.getIndexManager()), i.getAllMutationBatches(t3);
            }).next(function(e2) {
    ...
    return function(t4, e2, n2, r2) {
      ...
      return o.forEach(function(t5) {
        s = s.next(function() {
          ...
          P2(null !== o2), e3.version.compareTo(o2) < 0 && (i2.applyToRemoteDocument(e3, n2), e3.isValidDocument() && r2.addEntry(e3, n2.commitVersion));
        });
      }), s.next(function() {
      ...
      if (u2) {
        ...
        if (a2.approximateByteSize() > 0) {
          ...
          i = i.insert(o2, c), function(t4, e3, n2) {
            return P2(e3.resumeToken.approximateByteSize() > 0), 0 === t4.resumeToken.approximateByteSize() || (e3.snapshotVersion.toMicroseconds() - t4.snapshotVersion.toMicroseconds() >= 3e8 || n2.addedDocuments.size + n2.modifiedDocuments.size + n2.removedDocuments.size > 0);
...
function Qi(t2, e, n, r, i) {
  ...
  return n.forEach(function(t3) {
    ...
    return n.forEach(function(n2, s) {
      ...
      s.isNoDocument() && s.version.isEqual(K2.min()) ? (e.removeEntry(n2, a), o2 = o2.insert(n2, s)) : !u.isValidDocument() || s.version.compareTo(u.version) > 0 || 0 === s.version.compareTo(u.version) && u.hasPendingWrites ? (e.addEntry(s, a), o2 = o2.insert(n2, s)) : C2("LocalStore", "Ignoring outdated watch update for ", n2, ". Current version:", u.version, " Watch version:", s.version);
    }), o2;
  });
}
function zi(t2, e) {
...
function Wi(t2, e) {
  ...
  return n.persistence.runTransaction("Allocate target", "readwrite", function(t3) {
    ...
    return n.qe.getTargetData(t3, e).next(function(i) {
      return i ? (r = i, Ir.resolve(r)) : n.qe.allocateTargetId(t3).next(function(i2) {
...
var io = function() {
  function t2(t3, e) {
    this.Ut = t3, this.referenceDelegate = e, this._n = [], this.ss = 1, this.rs = new $e(ro.Gn);
  }
...
var oo = function() {
  function t2(t3, e) {
    this.Ut = t3, this.ls = e, this.docs = new We(ct.comparator), this.size = 0;
  }
  return t2.prototype.addEntry = function(t3, e, n) {
...
var uo = function() {
  function t2(t3) {
    this.persistence = t3, this.ds = new Ii(function(t4) {
      return kt(t4);
...
var ho = function() {
  function t2(t3) {
    this.persistence = t3, this.As = new no(), this.Rs = null;
  }
...
var Io = function() {
  function t2(t3, e, n, r, i) {
    this.window = t3, this.Se = e, this.persistenceKey = n, this.Ns = r, this.syncEngine = null, this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.xs = this.ks.bind(this), this.Fs = new We(q2), this.started = false, this.$s = [];
    var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    this.storage = this.window.localStorage, this.currentUser = i, this.Os = lo(this.persistenceKey, this.Ns), this.Ms = function(t4) {
      return "firestore_sequence_number_" + t4;
    }(this.persistenceKey), this.Fs = this.Fs.insert(this.Ns, new bo()), this.Ls = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), this.Bs = new RegExp("^firestore_mutations_" + o + "_(\\d+)(?:_(.*))?$"), this.qs = new RegExp("^firestore_targets_" + o + "_(\\d+)$"), this.Us = function(t4) {
  ...
  return t2.yt = function(t3) {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(e) {
        return t3.user.uid === this.currentUser.uid ? [2, this.syncEngine.ui(t3.batchId, t3.state, t3.error)] : (C2("SharedClientState", "Ignoring mutation for non-active user " + t3.user.uid), [2]);
      });
    });
...
var Do = function(e) {
    ...
    return m(d, WebChannel.EventType.OPEN, function() {
      ...
      if (!y2) {
        ...
        if (i2) {
          ...
          var o2 = i2.status, s = function(t4) {
            var e4 = Ue[t4];
            if (void 0 !== e4)
              return ze(e4);
          }(o2), u = i2.message;
          void 0 === s && (s = N2.INTERNAL, u = "Unknown error status: " + o2 + " with message " + i2.message), y2 = true, v2.Vi(new D2(s, u)), d.close();
        } else
  ...
  return t2.prototype.Ni = function(t3, e, n, r) {
    ...
    if (t3["X-Goog-Api-Client"] = "gl-js/ fire/8.10.1", t3["Content-Type"] = "text/plain", this.databaseInfo.appId && (t3["X-Firebase-GMPID"] = this.databaseInfo.appId), e)
...
var xo = function() {
  function t2(t3, e, n, r, i) {
    void 0 === n && (n = 1e3), void 0 === r && (r = 1.5), void 0 === i && (i = 6e4), this.Se = t3, this.timerId = e, this.Mi = n, this.Li = r, this.Bi = i, this.qi = 0, this.Ui = null, this.Ki = Date.now(), this.reset();
  }
...
var Ro = function() {
  function t2(t3, e, n, r, i, o) {
    this.Se = t3, this.zi = n, this.Hi = r, this.Ji = i, this.listener = o, this.state = 0, this.Yi = 0, this.Xi = null, this.stream = null, this.Zi = new xo(t3, e);
  }
  return t2.prototype.tr = function() {
    ...
    return __awaiter(this, void 0, void 0, function() {
      return __generator(this, function(n) {
        switch (n.label) {
          case 0:
            return this.ur(), this.Zi.cancel(), this.Yi++, 3 !== t3 ? this.Zi.reset() : e && e.code === N2.RESOURCE_EXHAUSTED ? (x2(e.toString()), x2("Using maximum backoff delay to prevent overloading the backend."), this.Zi.Qi()) : e && e.code === N2.UNAUTHENTICATED && this.Ji.invalidateToken(), null !== this.stream && (this.ar(), this.stream.close(), this.stream = null), this.state = t3, [4, this.listener.Ri(e)];
          case 1:
            return n.sent(), [2];
        }
      });
  ...
  return __extends(n, e), n.prototype.wr = function(t2) {
    ...
    e2.database = xn(this.R), e2.addTarget = function(t3, e3) {
      ...
      return (n3 = xt(r) ? {
        ...
        query: Vn(t3, r)
      }).targetId = e3.targetId, e3.resumeToken.approximateByteSize() > 0 ? n3.resumeToken = Tn(t3, e3.resumeToken) : e3.snapshotVersion.compareTo(K2.min()) > 0 && (n3.readTime = In(t3, e3.snapshotVersion.toTimestamp())), n3;
    }(this.R, t2);
...
var Oo = function(e) {
  ...
  return __extends(n, e), Object.defineProperty(n.prototype, "pr", {
    ...
    if (P2(!!t2.streamToken), this.lastStreamToken = t2.streamToken, this.gr) {
      this.Zi.reset();
      var e2 = function(t3, e3) {
        return t3 && t3.length > 0 ? (P2(void 0 !== e3), t3.map(function(t4) {
          return function(t5, e4) {
            var n3 = t5.updateTime ? En(t5.updateTime) : En(e4);
            return n3.isEqual(K2.min()) && (n3 = En(e4)), new Ne(n3, t5.transformResults || []);
          }(t4, e3);
        })) : [];
...
var Fo = function() {
  ...
  return t2.prototype.Sr = function() {
    ...
    "Online" === this.state ? this.Dr("Unknown") : (this.vr++, this.vr >= 1 && (this.kr(), this.Cr("Connection failed 1 times. Most recent error: " + t3.toString()), this.Dr("Offline")));
...
var Mo = function(t2, e, i, o, s) {
  var u = this;
  this.localStore = t2, this.datastore = e, this.asyncQueue = i, this.remoteSyncer = {}, this.Fr = [], this.$r = /* @__PURE__ */ new Map(), this.Or = /* @__PURE__ */ new Set(), this.Mr = [], this.Lr = s, this.Lr.di(function(t3) {
              ...
              return zo(this) ? (C2("RemoteStore", "Restarting streams for network reachability change."), [4, function(t5) {
                return __awaiter(this, void 0, void 0, function() {
                  ...
                  return __generator(this, function(n) {
                    switch (n.label) {
                      case 0:
                        return (e2 = F2(t5)).Or.add(4), [4, qo(e2)];
                      case 1:
...
function Uo(t2, e) {
  var n = F2(t2);
  n.$r.has(e.targetId) || (n.$r.set(e.targetId, e), Qo(n) ? Go(n) : us(n).er() && jo(n, e));
}
function Bo(t2, e) {
  var n = F2(t2), r = us(n);
  n.$r.delete(e), r.er() && Ko(n, e), 0 === n.$r.size && (r.er() ? r.ir() : zo(n) && n.Br.set("Unknown"));
}
function jo(t2, e) {
...
function Yo(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    return __generator(this, function(n) {
      return Wo(t2), Qo(t2) ? (t2.Br.Nr(e), Go(t2)) : t2.Br.set("Unknown"), [2];
    });
  });
}
function $o(t2, e, i) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(a) {
      switch (a.label) {
        case 0:
          if (t2.Br.set("Online"), !(e instanceof dn && 2 === e.state && e.cause))
            return [3, 6];
          a.label = 1;
        case 1:
          ...
          return s = a.sent(), i.compareTo(s) >= 0 ? [
            ...
            function(t3, e2) {
              ...
              return n.targetChanges.forEach(function(n2, r) {
                ...
                var n2 = t3.$r.get(e3);
                if (n2) {
                  t3.$r.set(e3, n2.withResumeToken(J2.EMPTY_BYTE_STRING, n2.snapshotVersion)), Ko(t3, e3);
            ...
            return __awaiter(o, void 0, void 0, function() {
              return __generator(this, function(e2) {
                switch (e2.label) {
                  ...
                  case 1:
                    return e2.sent(), t2.Or.delete(1), [4, Vo(t2)];
                  case 2:
                    return e2.sent(), [2];
                }
              });
          ...
          return e && as(t2).pr ? [4, function(t3, e2) {
            return __awaiter(this, void 0, void 0, function() {
              ...
              return __generator(this, function(r) {
                switch (r.label) {
                  case 0:
                    return Qe(i2 = e2.code) && i2 !== N2.ABORTED ? (n = t3.Fr.shift(), as(t3).sr(), [4, Jo(t3, function() {
...
function ss(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return n = F2(t2), e ? (n.Or.delete(2), [4, Vo(n)]) : [3, 2];
        case 1:
          return r.sent(), [3, 5];
        case 2:
  ...
  return t2.Ur || (t2.Ur = function(t3, e2, n) {
    ...
    return __awaiter(e, void 0, void 0, function() {
      return __generator(this, function(e2) {
        switch (e2.label) {
          case 0:
            return i ? (t2.Ur.sr(), Qo(t2) ? Go(t2) : t2.Br.set("Unknown"), [3, 3]) : [3, 1];
          case 1:
            return [4, t2.Ur.stop()];
          case 2:
...
var cs = function() {
  function t2(t3, e, n, r, i) {
    this.asyncQueue = t3, this.timerId = e, this.targetTimeMs = n, this.op = r, this.removalCallback = i, this.deferred = new br(), this.then = this.deferred.promise.then.bind(this.deferred.promise), this.deferred.promise.catch(function(t4) {
    });
  }
...
var ls = function() {
  ...
  return t2.prototype.track = function(t3) {
    ...
    n ? 0 !== t3.type && 3 === n.type ? this.Qr = this.Qr.insert(e, t3) : 3 === t3.type && 1 !== n.type ? this.Qr = this.Qr.insert(e, {
      type: n.type,
      doc: t3.doc
      ...
      type: 2,
      doc: t3.doc
    }) : O2() : this.Qr = this.Qr.insert(e, t3);
...
function ms(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    var n, i, o, s, u;
    return __generator(this, function(r) {
      return n = F2(t2), i = e.query, o = false, (s = n.queries.get(i)) && (u = s.listeners.indexOf(e)) >= 0 && (s.listeners.splice(u, 1), o = 0 === s.listeners.length), o ? [2, (n.queries.delete(i), n.onUnlisten(i))] : [2];
    });
  });
}
function gs(t2, e) {
...
var Es = function() {
  function t2(t3, e, n) {
    this.ro = t3, this.localStore = e, this.R = n, this.queries = [], this.documents = [], this.progress = Ss(t3);
  }
...
var As = function() {
  function t2(t3, e) {
    this.query = t3, this.uo = e, this.ao = null, this.current = false, this.ho = sn(), this.mutatedKeys = sn(), this.lo = ae(t3), this.fo = new fs(this.lo);
  }
  return Object.defineProperty(t2.prototype, "wo", {
    ...
    if (t3.inorderTraversal(function(t4, e2) {
      var h2 = i.get(t4), f = ue(n.query, e2) ? e2 : null, l2 = !!h2 && n.mutatedKeys.has(h2.key), d = !!f && (f.hasLocalMutations || n.mutatedKeys.has(f.key) && f.hasCommittedMutations), p2 = false;
...
var xs = function() {
  function t2(t3, e, n, r, i, o) {
    this.localStore = t3, this.remoteStore = e, this.eventManager = n, this.sharedClientState = r, this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.vo = {}, this.Po = new Ii(function(t4) {
      return oe(t4);
    }, ie), this.Vo = /* @__PURE__ */ new Map(), this.So = /* @__PURE__ */ new Set(), this.Do = new We(ct.comparator), this.Co = /* @__PURE__ */ new Map(), this.No = new no(), this.xo = {}, this.ko = /* @__PURE__ */ new Map(), this.Fo = ci.Yt(), this.onlineState = "Unknown", this.$o = void 0;
  }
...
function Rs(t2, e) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return n = uu(t2), (s = n.Po.get(e)) ? (i = s.targetId, n.sharedClientState.addLocalQueryTarget(i), o = s.view.Ro(), [3, 4]) : [3, 1];
        case 1:
      ...
      switch (r.label) {
        case 0:
          return n = F2(t2), i = n.Po.get(e), (o = n.Vo.get(i.targetId)).length > 1 ? [2, (n.Vo.set(i.targetId, o.filter(function(t3) {
            return !ie(t3, e);
          })), void n.Po.delete(e))] : n.isPrimaryClient ? (n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [3, 2] : [4, Hi(
            n.localStore,
            i.targetId,
            false
          ).then(function() {
            ...
            return r2.persistence.runTransaction("Locally write mutations", "readwrite", function(t4) {
              return r2.Mn.pn(t4, o2).next(function(o3) {
                ...
                for (var s2 = [], u2 = 0, a = e2; u2 < a.length; u2++) {
                  ...
                  null != h && s2.push(new Fe(c.key, h, St(h.value.mapValue), De.exists(true)));
                }
      ...
      switch (r.label) {
        ...
        case 2:
          return i = r.sent(), e.targetChanges.forEach(function(t3, e2) {
            var r2 = n.Co.get(e2);
            r2 && (P2(t3.addedDocuments.size + t3.modifiedDocuments.size + t3.removedDocuments.size <= 1), t3.addedDocuments.size > 0 ? r2.bo = true : t3.modifiedDocuments.size > 0 ? P2(r2.bo) : t3.removedDocuments.size > 0 && (P2(r2.bo), r2.bo = false));
          }), [4, Ys(n, i, e)];
        case 3:
          return r.sent(), [3, 6];
        case 4:
...
function zs(t2, e, n) {
  for (var r = 0, i = n; r < i.length; r++) {
    var o = i[r];
    o instanceof Ns ? (t2.No.addReference(o.key, e), Ws(t2, o)) : o instanceof Ds ? (C2("SyncEngine", "Document no longer in limbo: " + o.key), t2.No.removeReference(o.key, e), t2.No.containsKey(o.key) || Qs(t2, o.key)) : O2();
  }
}
function Ws(t2, e) {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        ...
        case 2:
          return r.sent(), [3, 4];
        case 3:
          "acknowledged" === i || "rejected" === i ? (Ks(n, e, o || null), js(n, e), function(t3, e2) {
            F2(F2(t3)._n).Gt(e2);
...
function ou(t2, e, i, o) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(r) {
      switch (r.label) {
        case 0:
          return (n = F2(t2)).$o ? (C2("SyncEngine", "Ignoring unexpected query state notification."), [3, 8]) : [3, 1];
        case 1:
          if (!n.Vo.has(e))
            return [3, 8];
          switch (i) {
    ...
    return function(t3) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(n) {
          switch (n.label) {
            case 0:
              return e = F2(t3), C2("RemoteStore", "RemoteStore shutting down."), e.Or.add(5), [4, qo(e)];
            case 1:
...
var vu = function() {
  function t2(t3, e) {
    var n = this;
    this.Go = t3, this.R = e, this.metadata = new br(), this.buffer = new Uint8Array(), this.zo = new TextDecoder("utf-8"), this.Ho().then(function(t4) {
      ...
      return __generator(this, function(n) {
        switch (n.label) {
          ...
          case 2:
            return [3, 0];
          case 3:
            return 0 === this.buffer.length ? [2, null] : ((t3 = this.Zo()) < 0 && this.Yo("Reached the end of bundle when a length string is expected."), e = this.buffer.slice(0, t3), [2, (this.buffer = this.buffer.slice(t3), e)]);
        }
      });
    });
...
var gu = function() {
  function t2(t3, e, n, r) {
    this.asyncQueue = t3, this.datastore = e, this.updateFunction = n, this.deferred = r, this.ec = 5, this.Zi = new xo(this.asyncQueue, "transaction_retry");
  }
            ...
            return function(t4, e2) {
              return __awaiter(this, void 0, void 0, function() {
                ...
                return __generator(this, function(r) {
                  switch (r.label) {
                    case 0:
                      return (n = F2(t4)).asyncQueue.verifyOperationInProgress(), C2("RemoteStore", "RemoteStore received new credentials"), i2 = zo(n), n.Or.add(3), [4, qo(n)];
                    case 1:
...
var xu = function(t2, e, n, r, i, o, s, u) {
...
var Ju = function(e) {
  function n(t2, n2, r) {
    var i = this;
    return (i = e.call(this, t2, n2, Yt(r)) || this)._path = r, i.type = "collection", i;
  }
...
function Zu(t2, n) {
  ...
  if (t2 = getModularInstance(t2), Uu("collection", "path", n), t2 instanceof Yu)
    return Gu(r = H2.fromString.apply(H2, __spreadArray([n], i))), new Ju(t2, null, r);
...
function ta2(t2, n) {
  for (var r, i = [], o = 2; o < arguments.length; o++)
    i[o - 2] = arguments[o];
  if (t2 = getModularInstance(t2), 1 === arguments.length && (n = V2.u()), Uu("doc", "path", n), t2 instanceof Yu)
...
var ra2 = function() {
  ...
  return Object.defineProperty(t2.prototype, "isShuttingDown", {
    ...
    var r = this;
    this.Ac(), this.Tc.indexOf(t3) > -1 && (e = 0);
    ...
    return __awaiter(o, void 0, void 0, function() {
      ...
      return __generator(this, function(r) {
        switch (r.label) {
          ...
          case 3:
            if (!function(t3) {
              return "FirebaseError" === t3.name ? t3.code === N2.FAILED_PRECONDITION || t3.code === N2.UNIMPLEMENTED : !("undefined" != typeof DOMException && t3 instanceof DOMException) || (22 === t3.code || 20 === t3.code || 11 === t3.code);
            }(n = r.sent()))
              throw n;
...
var ba2 = function() {
  function t2(t3, e, n, r, i, o) {
    this.settings = t3, this.databaseId = e, this.R = n, this.ignoreUndefinedProperties = r, void 0 === i && this.Cc(), this.fieldTransforms = i || [], this.fieldMask = o || [];
  }
...
function Oa(t2, e) {
  var n = {};
  return z2(t2) ? e.path && e.path.length > 0 && e.fieldMask.push(e.path) : Q2(t2, function(t3, r) {
    var i = La2(r, e.kc(t3));
    null != i && (n[t3] = i);
  }), {
    mapValue: {
...
function vc2(t2, e, n) {
  ...
  return gc2(o, [("string" == typeof (e = getModularInstance(e)) || e instanceof la2 ? xa2(s, "updateDoc", t2._key, e, n, r) : Ca2(s, "updateDoc", t2._key, e)).toMutation(t2._key, De.exists(true))]);
}
function mc2(t2) {
...
var Sc2 = function() {
  ...
  return Object.defineProperty(t2.prototype, "_databaseId", {
    ...
    t3.merge || e.host === t3.host || R2("You are overriding the original host. If you did not intend to override your settings, use {merge: true}."), t3.merge && delete (t3 = Object.assign(Object.assign({}, e), t3)).merge, this._delegate._setSettings(t3);
                ...
                return i = o.sent(), [2, (e2.setNetworkEnabled(false), function(t4) {
                  return __awaiter(this, void 0, void 0, function() {
                    ...
                    return __generator(this, function(n) {
                      switch (n.label) {
                        case 0:
                          return (e3 = F2(t4)).Or.add(0), [4, qo(e3)];
                        case 1:
          ...
          return __awaiter(i, void 0, void 0, function() {
            ...
            return __generator(this, function(r) {
              switch (r.label) {
                ...
                case 1:
                  return n = r.sent(), new gu(t5.asyncQueue, n, e3, o).run(), [2];
              }
            });
          });
        }), o.promise;
...
var Nc2 = function(e) {
  ...
  return __extends(n, e), n.prototype.convertBytes = function(t2) {
    ...
    var e2 = this.convertDocumentKey(t2, this.firestore._databaseId);
    return xc2.eu(e2, this.firestore, null);
  }, n;
}(cc2);
function Dc2(t2) {
  var e;
  ...
  return t2.prototype.where = function(e, n, r) {
    ...
    try {
      return new t2(this.firestore, Za2(this._delegate, function(t3) {
        return Wu("limit", t3), new nc2("limit", t3, "F");
      }(e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Za2(this._delegate, function(t3) {
        return Wu("limitToLast", t3), new nc2("limitToLast", t3, "L");
      }(e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Za2(this._delegate, function() {
        for (var t3 = [], e2 = 0; e2 < arguments.length; e2++)
          t3[e2] = arguments[e2];
        return new rc2("startAt", t3, true);
      }.apply(void 0, e)));
    } catch (e2) {
    ...
    try {
      return new t2(this.firestore, Za2(this._delegate, function() {
        for (var t3 = [], e2 = 0; e2 < arguments.length; e2++)
          t3[e2] = arguments[e2];
        return new ic2("endBefore", t3, true);
      }.apply(void 0, e)));
    } catch (e2) {
