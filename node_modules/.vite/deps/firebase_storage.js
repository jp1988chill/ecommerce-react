    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4, ref2.storage.makeRequestWithTokens(requestInfo)];
        case 1:
          return [2, _a.sent().getPromise()];
      }
    });
  });
}
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          requestInfo = getMetadata$2(ref2.storage, ref2._location, getMappings());
          return [4, ref2.storage.makeRequestWithTokens(requestInfo)];
        case 1:
          return [2, _a.sent().getPromise()];
      }
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          requestInfo = updateMetadata$2(ref2.storage, ref2._location, metadata, getMappings());
          return [4, ref2.storage.makeRequestWithTokens(requestInfo)];
        case 1:
          return [2, _a.sent().getPromise()];
      }
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          return [4, ref2.storage.makeRequestWithTokens(requestInfo)];
        case 1:
          return [2, _a.sent().getPromise().then(function(url) {
            if (url === null) {
              throw noDownloadURL();
            }
            return url;
    ...
    return __generator(this, function(_a) {
      switch (_a.label) {
        case 0:
          ...
          requestInfo = deleteObject$2(ref2.storage, ref2._location);
          return [4, ref2.storage.makeRequestWithTokens(requestInfo)];
        case 1:
          return [2, _a.sent().getPromise()];
      }
